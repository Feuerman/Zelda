...
<!-- onclick переехал в bitrix/components/bit/form.request/templates/.default/script.js:10
 ...
 -->
<button data-toggle="modal" data-target="#fbModal">Бесплатная консультация</button>
...
<div class="modal fade" id="fbModal" tabindex="-1" role="dialog" aria-labelledby="fbModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-request ">
        <div class="modal-content modal-content-request">
            <form action="<?=$templateFolder.'/ajax.php'?>" method="post" class="form form_fb">
                <input type="hidden" name="bit-ajax" value="Y"/>
                <div class="modal-header modal-header-request">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> </button>
                    <h4 class="modal-title" id="requestModalLabel">Запрос на консультацию "Какую лицензию выбрать"</h4>
                </div>
                <div class="modal-body modal-body-request">
                    ...
                    <div class="email_input input">
					 ...
					 <input type="hidden" name="MORE_INFO" value="<?=$arParams["MORE_INFO"]?>">
                </div>
